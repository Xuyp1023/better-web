...
define(function(require,exports,module){
	...
	var _personModule = {
		...
		//获取销售机构
		getAgencyList : function(callback){
			$.post(common.getRootPath()+'/SaleQuery/querySaleAgencyKeyAndValue',{},function(data){
				if(data.code === 200){
					_personModule.initInfo($('#search_comp_list'),data.data,'','name','value');
					if(callback) callback();
				}
	...
	//数据初始化
	_personModule.getAgencyList(function(){
