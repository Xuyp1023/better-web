...
exports.installController = function(mainApp,common){
	...
	mainApp.controller('billPool.detailDidController',['$scope','$location','muiSupport','http','$rootScope','$route','cache','wx','$route',
		function($scope,$location,muiSupport,http,$rootScope,$route,cache,wx,$route){
		/*私有属性区域*/
		_statusPicker = {};
		...
		$scope.goDidFlow=function(){
			$location.path('/financeBusi/detail/{{item.requestNo}}');
		}
