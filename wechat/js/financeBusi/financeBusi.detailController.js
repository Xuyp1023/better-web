...
exports.installController = function(mainApp,common){
	...
	mainApp.controller('financeBusi.detailController',['$scope','muiSupport','http','$rootScope','$route','cache','commonService',function($scope,muiSupport,http,$rootScope,$route,cache,commonService){
		...
		$scope.$on('$routeChangeSuccess',function(){
			...
			var requestNo = $route.current.pathParams.requestNo;
			...
			$scope.queryFinanceInfo(requestNo).success(function(){
                ...
                //融资材料列表
				//commonService.queryBaseInfoList(BTPATH.QUERY_REQUEST_FILE,{batchNo:$scope.info.batchNo},$scope,'materialList');
			...
			//查询其他资料列表
			commonService.queryBaseInfoList(BTPATH.QUERY_OTHER_FILE,{requestNo:requestNo},$scope,'otherInfoList');
			//获取融资协议列表
