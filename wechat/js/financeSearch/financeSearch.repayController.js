...
exports.installController = function(mainApp,common){
	...
	mainApp.controller('financeSearch.repayController',['$scope','muiSupport','http','$rootScope','$route','cache',function($scope,muiSupport,http,$rootScope,$route,cache){
		...
		$scope.searchData = {
	      ...
	      lastStatus:'4,5,6,7'	//4还款中， 5逾期，6 展期，7坏帐
		};
