...
define(function(require,exports,module){
	...
	exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
		...
		mainApp.controller('seller.contractList',['$scope','http','$rootScope','$route','cache','$location',function($scope,http,$rootScope,$route,cache,$location){
      /*  VM绑定区域  */
      $scope.infoList = [];
      $scope.info = {};
      //分页数据
      ...
      $scope.showEditPage = function(contractId){
          ...
          $location.url("/sellerContract/edit/"+contractId);
      };

      //打开作废页面
      $scope.showCancelPage = function(contractId){

          $location.url("/sellerContract/cancel/"+contractId);
      };      
