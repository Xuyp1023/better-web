...
define(function(require,exports,module){
	...
	exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
		...
		mainApp.controller('seller.contractAduit',['$scope','http','$rootScope','$route','cache','$location',function($scope,http,$rootScope,$route,cache,$location){
      /*  VM绑定区域  */
      $scope.infoList = [];
      $scope.info = {};
      //分页数据
      ...
      $scope.showAduitPage = function(contractId,businStatus){
          ...
          $location.url("/sellerContract/aduitInfo/"+contractId+"/"+businStatus);
      };   
