...
define(function(require,exports,module){
	...
	exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
		...
		mainApp.controller('seller.contractEdit',['$scope','http','$rootScope','$route','cache','upload','$location','$window',function($scope,http,$rootScope,$route,cache,upload,$location,$window){
      ...
      /*  业务处理绑定区域  */
			...
			$scope.queryCoreCustList = function(){
				$.post(BTPATH.QUERY_DIC_CORECUSTLIST,{custNo:$scope.info.buyerNo},function(data){
