...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('supplier.contractQuery',['$scope','http','$rootScope','$route','cache','$location',function($scope,http,$rootScope,$route,cache,$location){
      /*  VM绑定区域  */
      $scope.infoList = [];
      $scope.info = {};
      //分页数据
     ...
     /* $scope.statusList = [
      ...
      $scope.statusList = BTDict.ledgerVersionBusinStatus.toArray('value','name');
      ...
      $scope.showPage = function(contractId){
          ...
          $location.url("/supplierContract/contractInfo/"+contractId);
      };   
