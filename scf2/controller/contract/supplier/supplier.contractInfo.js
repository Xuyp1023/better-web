...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('supplier.contractInfo',['$scope','http','$rootScope','$route','cache','upload','$location',function($scope,http,$rootScope,$route,cache,upload,$location){
    ...
    fileList:null,
      ...
      $scope.goBack = function(){
        $location.url("/supplierContract/query");
      };
