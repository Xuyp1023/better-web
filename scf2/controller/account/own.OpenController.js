...
define(function(require,exports,module){
	...
	exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
		...
		mainApp.controller('own.OpenController',['$scope','http','$rootScope','$route','cache','commonService','$timeout',function($scope,http,$rootScope,$route,cache,commonService,$timeout){
