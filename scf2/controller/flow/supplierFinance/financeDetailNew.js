...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('financeDetailNew',['$scope','http','$rootScope','$route','cache','commonService','$location','flowService',function($scope,http,$rootScope,$route,cache,commonService,$location,flowService){
      /*  VM绑定区域  */
      

      $scope.periodUnits = BTDict.PeriodUnit.toArray('value','name');   //期限单位       
      $scope.info = {};
      if(cache.get('detailIf')){
        $scope.temporary=cache.get('detailIf');
      }
      //当前任务
