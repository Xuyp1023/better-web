...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('launchSignContract',['$scope','http','$rootScope','$route','cache','commonService','$location','flowService',function($scope,http,$rootScope,$route,cache,commonService,$location,flowService){
      /*  VM绑定区域  */
     ...
     /* // 打开融资批复
      ...
      $scope.signContract = function(){
        $scope.openRollModal('agreement');
      }
      $scope.addsignContract = function(){
        window.location.href = '../scf2/home.html?rn='+new Date().getTime()+'/#/flow/supplierFinance/addsignContract';
      }
      // 资产登记查询
