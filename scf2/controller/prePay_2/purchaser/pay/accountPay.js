...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('pay.account2',['$scope','http','$rootScope','$route','cache','commonService','$location','$filter',function($scope,http,$rootScope,$route,cache,commonService,$location,$filter){
      // 供应商报价列表
      $scope.infoList = [];
      ...
      $scope.lookDetail = function(data) {
          window.location.href='../byte/home1.html#/scf/prepay/apply2?id='+data.requestNo+'&src=3.html';
      }

       $scope.detail_adpay = function(data) {
      ...
      $scope.queryList = function(flag){
        ...
        http.post(BTPATH.QUERY_RECEIVABLE_REQUEST_queryTwoFinishReceivableRequestWithSupplier,$.extend({},$scope.listPage,$scope.searchData))
