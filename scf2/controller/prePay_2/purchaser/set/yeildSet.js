...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('set.yeild2',['$scope','http','$rootScope','$route','cache','commonService','$location','$filter',function($scope,http,$rootScope,$route,cache,commonService,$location,$filter){
      // 供应商报价列表
      $scope.infoList = [];
      ...
      $scope.addInfoBox = function(){
        ...
        // $scope.queryAddList();
        $scope.info.custNo=common.filterArrayFirst($scope.financeCustList);
      ...
      $scope.doConfirm=function(target,dataInfo){          
          var $target=$(target); 
        //设置校验项 | 校验   新增利率的角色1 核心企业  2 平台   3 保理公司
