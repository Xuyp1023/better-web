...
define(function (require, exports, module) {
      ...
      exports.installController = function (mainApp, common, validate, tipbar, loading, comdirect, dialog) {
        ...
        mainApp.controller('set.arapmenttw', ['$scope', 'http', '$rootScope', '$route', 'cache', 'commonService', '$location', '$filter', function ($scope, http, $rootScope, $route, cache, commonService, $location, $filter) {
          ...
          $scope.addInfo = function(){
            ...
            window.location.href='../byte/home1.html#/scf/prepay/apply2?id=21412412&src=1.html';
          ...
          $scope.apply_adpay = function(datainfo){
            ...
            if(datainfo.receivableRequestType=='2'){
             window.location.href='../byte/home1.html#/scf/prepay/apply2?id='+datainfo.requestNo+'&src=2.html';
            }

            if(datainfo.receivableRequestType=='1'){
          ...
          $scope.searchList = function () {
           ...
           $scope.queryList = function(flag){
            ...
            http.post(BTPATH.QUERY_RECEIVABLE_REQUEST_queryREeceivableRequestTwoWithSupplier,$.extend({},$scope.listPage,$scope.searchData))
              .success(function(data){
                //关闭加载状态弹幕
