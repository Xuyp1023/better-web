...
define(function (require, exports, module) {
      ...
      exports.installController = function (mainApp, common, validate, tipbar, loading, comdirect, dialog) {
        ...
        mainApp.controller('set.adpaydetailstw', ['$scope', 'http', '$rootScope', '$route', 'cache', 'commonService', '$location', '$filter', function ($scope, http, $rootScope, $route, cache, commonService, $location, $filter) {
          ...
          $scope.searchList = function () {
           ...
           $scope.queryList = function(flag){
            ...
            http.post(BTPATH.QUERY_RECEIVABLE_REQUEST_queryTwoFInishedREeceivableRequestTwoWithSupplier,$.extend({},$scope.listPage,$scope.searchData))
