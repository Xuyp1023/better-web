...
define(function (require, exports, module) {
      ...
      exports.installController = function (mainApp, common, validate, tipbar, loading, comdirect, dialog) {
        ...
        mainApp.controller('set.apmenttw', ['$scope', 'http', '$rootScope', '$route', 'cache', 'commonService', '$location', '$filter', function ($scope, http, $rootScope, $route, cache, commonService, $location, $filter) {
          ...
          dddd.setDate(1);
           ...
           // 初始化查条件对象
           $scope.searchData = {
            GTEendDate:dddd.getSubDate('MM',0).format('YYYY-MM-DD'),
          ...
          $scope.apply_adpay = function(target,dataInfo){
            ...
            var $target=$(target);
            http.post(BTPATH.SAVE_RECEIVABLE_REQUEST_SAVEADDREQUESTTOTAL,{receivableId:dataInfo.id})

              .success(function(data){
               
                if(common.isCurrentData(data)){
                  window.location.href='../byte/home1.html#/scf/prepay/apply_N?id='+data.data.requestNo+'&src=1.html';
                }else{
