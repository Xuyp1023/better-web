...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('account.details',['$scope','http','$rootScope','$route','cache','commonService','$location','toLoad',function($scope,http,$rootScope,$route,cache,commonService,$location,toLoad){
      /*  VM绑定区域  */
