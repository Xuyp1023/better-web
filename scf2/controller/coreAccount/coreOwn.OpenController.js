...
define(function(require,exports,module){
	...
	exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
		...
		mainApp.controller('coreOwn.OpenController',['$scope','http','$rootScope','$route','cache','commonService','$timeout',function($scope,http,$rootScope,$route,cache,commonService,$timeout){
			...
			//核心企业类型
			$scope.coreenterpriseList = BTDict.FactorCoreCustInfo.toArray('value','name');
			//银行证件类型
			...
			$scope.info = {
	        	...
	        	// coreenterpriseType : common.filterArrayFirst($scope.coreenterpriseList),
