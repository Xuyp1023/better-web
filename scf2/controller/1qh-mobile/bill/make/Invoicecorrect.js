...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('check.Invoicecorrect',['$scope','http','$rootScope','$route','cache','commonService','$routeParams',function($scope,http,$rootScope,$route,cache,commonService,$routeParams){
      /*  VM绑定区域  */

      $scope.goback = function(){
       window.location.href = '../scf2/home.html?rn='+new Date().getTime()+'/#/1qh-mobile/Invoiceaffirm';
    }
      $scope.goInvoicearm = function(target,id){
       ...
       //弹出弹幕加载状态
        ...
        http.post(BTPATH.SAVE_COMMISSION_INVOICE_SAVECONFIRMINVOICE/*2*/,{invoiceId:id})
