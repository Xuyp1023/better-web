...
define(function(require,exports,module){
  ...
  exports.installController = function(mainApp,common,validate,tipbar,loading,comdirect,dialog){
    ...
    mainApp.controller('assetmanage.bill.audit',['$scope','http','$rootScope','$route','cache','commonService',function($scope,http,$rootScope,$route,cache,commonService){
      /*  VM绑定区域  */
    ...
    $scope.delUploadItem = function(item,listName){
      ...
      $scope.pendingInfoBox = function(dataInfo){
          ...
          http.post(BTPATH.FIND_SUPPLIER_OFFER_FINDOFFER,{custNo:dataInfo.custNo,coreCustNo:dataInfo.coreCustNo})
           .success(function(data){
            if(data&&(data.code === 200)){
              
              $scope.$apply(function(){
                    $scope.loanInfo.custCoreRate=data.data.coreCustRate;
      ...
      $scope.pendInfot = function(target,item){
        ...
        var $target = $(target);        
        http.post(BTPATH.SAVE_AUDIT_RECEIVABLE_RECORD_CORE,{refNo:item.refNo,version:item.version,custCoreRate:'0'})
           .success(function(data){
            if(data&&(data.code === 200)){
