...
function BetterDictionary() {
		...
		this.ContractCorpAccountRegType.set('00', '法人');
		this.ContractCorpAccountRegType.set('01', '代理人');
		...
		//佣金文件状态  业务状态 0 未处理 1 已处理 2已审核 3删除
		...
		this.commissionFileStatus.set('3', '已删除');
	  ...
	  this.RiskAssessment.set('205','南方基金');
